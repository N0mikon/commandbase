...
status: archived
archived: 2026-02-09
archive_reason: "Implementation complete; original reference newskills/creating-hooks/SKILL.md no longer exists (moved to plugins/commandbase-meta/skills/creating-hooks/). Fix was applied and verified. 29 commits behind HEAD."
references:

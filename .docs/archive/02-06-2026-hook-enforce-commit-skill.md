...
archived: 2026-02-09
archive_reason: "Superseded by 02-06-2026-claude-md-vs-hooks-commit-enforcement.md which covers the same topic more comprehensively with the final layered strategy recommendation. Implementation completed in commandbase-git-workflow plugin."
references:

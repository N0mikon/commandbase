...
archived: 2026-02-09
archive_reason: "Phase 1 foundations fully implemented and implementation plans already archived. References point to old ~/.claude/skills/* paths; skills now live in plugins/. Research has served its purpose."
references:

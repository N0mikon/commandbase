...
git_commit: 8e92bba
archived: 2026-02-09
archive_reason: "Research complete. Recommended approach (PostToolUseFailure for subagent + Stop hook transcript parsing for main conversation) fully implemented in commandbase-session plugin as track-errors.py and harvest-errors.py. Findings also incorporated into creating-hooks skill."
---

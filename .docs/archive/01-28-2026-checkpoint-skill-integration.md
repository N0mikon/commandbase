...
last_updated_note: "Archived - plan fully completed and shipped; all newskills/* references deleted (moved to plugins/)"
...
status: archived
archived: 2026-02-09
archive_reason: "Plan fully implemented. All referenced files under newskills/ have been deleted. Feature shipped at plugins/commandbase-core/skills/bookmarking-code/."
references:

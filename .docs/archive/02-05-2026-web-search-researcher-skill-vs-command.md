...
status: archived
archived: 2026-02-09
archive_reason: "Decision complete and implemented. Option C (orchestrator skill) was built at plugins/commandbase-research/skills/researching-web/. All referenced paths (~/.claude/agents/, ~/.claude/skills/) are pre-plugin install paths that no longer exist. Companion doc also archived."
references:

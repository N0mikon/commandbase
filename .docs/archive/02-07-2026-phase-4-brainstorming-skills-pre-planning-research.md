...
git_commit: 8e92bba
archived: 2026-02-09
archive_reason: "Research fully consumed by Phase 4 implementation (commit 0c8fd24). All 3 brainstorming skills shipped, /discussing-features retired, docs-writer extended. References point to old install paths (~/.claude/skills/*, ~/.claude/agents/*) now relocated to plugins/."
references:

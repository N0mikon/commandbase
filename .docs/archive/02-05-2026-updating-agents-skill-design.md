...
category: research
archived: 2026-02-09
archive_reason: "Research fully consumed. Skill implemented as /auditing-agents at plugins/commandbase-meta/skills/auditing-agents/. Agent inventory and file paths are outdated (agents moved from ~/.claude/agents/ to plugins/*/agents/, docs-writer agent added, skill renamed from updating-agents to auditing-agents)."
references:
  - plugins/commandbase-meta/skills/auditing-agents/SKILL.md
  - plugins/commandbase-meta/skills/auditing-agents/reference/audit-checklist.md
  - plugins/commandbase-meta/skills/auditing-agents/reference/common-fixes.md
---

...
status: archived
archived: 2026-02-09
archive_reason: "Plan complete. Referenced skill paths (~/.claude/skills/*) no longer exist; skills restructured into plugins/ (commandbase-code, commandbase-git-workflow). Hardening changes were applied and carried forward into the plugin layout."
references:

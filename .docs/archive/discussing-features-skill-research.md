...
last_updated_note: "Archived - discussing-features skill retired and absorbed into brainstorming-code"
topic: "discussing-features skill research"
tags: [research, skill, discussing-features, context-engineering, pre-planning]
status: archived
archived: 2026-02-09
archive_reason: "Skill retired. discussing-features was absorbed by /brainstorming-code (commandbase-code plugin) in Phase 4 implementation. All referenced files (SKILL.md, question-domains.md, context-template.md) moved to .docs/archive/discussing-features/. No active skill exists at ~/.claude/skills/discussing-features/ or in any plugin."
superseded_by:

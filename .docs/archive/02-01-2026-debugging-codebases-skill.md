...
last_updated_note: "Archived - completed plan with all references moved from newskills/ to plugins/commandbase-code/skills/"
topic: "Debugging Codebases Skill"
tags: [plan, implementation, skill, debugging, rpi-workflow]
status: archived
completed_date: 2026-02-01
archived: 2026-02-09
archive_reason: "Completed implementation plan (2026-02-01). All referenced files moved from newskills/debugging-code/* to plugins/commandbase-code/skills/debugging-code/* in repo restructuring (commit 87a19a3). 48 commits behind HEAD."
references:

...
last_updated_note: "Updated after 61 commits - refreshed references to plugin paths, bumped git_commit to current HEAD"
...
status: archived
archived: 2026-02-09
archive_reason: "Blueprint fully implemented and shipped. Skill moved from newskills/learning-from-sessions/ to plugins/commandbase-session/skills/learning-from-sessions/. All newskills/* references are stale (paths deleted). Original design context preserved."
references:
  - .docs/plans/learning-from-sessions-blueprint.md
  - plugins/commandbase-session/skills/learning-from-sessions/SKILL.md
  - plugins/commandbase-session/skills/learning-from-sessions/reference/extraction-workflow.md
  - plugins/commandbase-session/skills/learning-from-sessions/reference/quality-gates.md
  - plugins/commandbase-session/skills/learning-from-sessions/reference/description-optimization.md
  - plugins/commandbase-session/skills/learning-from-sessions/reference/research-foundations.md
  - plugins/commandbase-session/skills/learning-from-sessions/templates/extracted-skill-template.md
...
This blueprint has been implemented. The `learning-from-sessions` skill now exists at `plugins/commandbase-session/skills/learning-from-sessions/` (originally created at `newskills/learning-from-sessions/`, moved to the plugin structure in the marketplace conversion). The old `newskills/learn/SKILL.md` and `newreference/pattern-learning.md` were replaced by this implementation. The skill has since evolved to include session awareness, debug file integration, and git worktree support beyond the original blueprint scope.
...
The blueprint proposed this structure (now implemented at `plugins/commandbase-session/skills/learning-from-sessions/`):

```
plugins/commandbase-session/skills/learning-from-sessions/
├── SKILL.md                              # Core workflow (338 lines as of v2.1)
├── reference/
...
└── templates/
    ...
    └── learnings-template.md            # Template for .docs/learnings/ output (added post-blueprint)
```
...
- `plugins/commandbase-session/skills/learning-from-sessions/SKILL.md` - Implemented skill (current location)
- ~~`newskills/learn/SKILL.md:1-172`~~ - Former simpler learn skill (deleted)
- ~~`newreference/pattern-learning.md:1-56`~~ - Former pattern learning reference (deleted)
...
4. **Reference to `creating-skills`**: RESOLVED - The `creating-skills` skill now exists at `plugins/commandbase-meta/skills/creating-skills/` with full validation rules and templates.

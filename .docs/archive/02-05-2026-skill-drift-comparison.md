...
topic: "Skill Drift Comparison: Global vs newskills"
tags: [research, skills, drift, sync, audit]
status: archived
archived: 2026-02-09
archive_reason: "One-time audit with all action items completed on 2026-02-05. Both referenced directories (newskills/ and ~/.claude/skills/) no longer exist; skills were restructured into plugins/ via plugin marketplace (commit 87a19a3). The global-vs-repo drift problem no longer applies."
references:

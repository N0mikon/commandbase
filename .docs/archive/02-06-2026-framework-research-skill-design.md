...
status: archived
archived: 2026-02-09
archive_reason: "Design consumed — researching-frameworks skill implemented at plugins/commandbase-research/skills/researching-frameworks/. Referenced files (newskills/starting-projects/SKILL.md, newskills/researching-web/SKILL.md) moved to plugins/ during plugin restructure."
references:

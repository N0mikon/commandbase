...
last_updated_note: "Archived - discussing-features skill retired; all referenced files removed from active codebase"
topic: "/discussing-features Skill Implementation"
tags: [plan, skill, discussing-features, pre-planning, context-engineering]
status: archived
archived: 2026-02-09
archive_reason: "Skill retired entirely. All referenced newskills/discussing-features/* files deleted from active paths (previously moved to .docs/archive/discussing-features/). Referenced research also archived."
research: .docs/archive/02-01-2026-get-shit-done-skill-comparison.md
references:

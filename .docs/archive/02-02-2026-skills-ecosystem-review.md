...
git_commit: 8e92bba
archived: 2026-02-09
archive_reason: "Ecosystem fundamentally restructured: skills moved from ~/.claude/skills/ (18 skills) to plugin marketplace (8 plugins, 46 skills). Key recommendation (reviewing-changes) implemented. discussing-features retired. Session skills renamed (handing-over->ending-session, taking-over->resuming-session). Superseded by 02-08-2026-plugin-conversion-analysis-skills-agents-hooks.md."
references:
...
Date: 2026-02-02
Scope: All 18 skills in ~/.claude/skills/ (historical -- now 46 skills across 8 plugins)
